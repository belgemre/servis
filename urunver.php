		...
		<form role="form" method="post" id="verilenurunler" action="" onsubmit="return false;" >
			...
			<div class="row">
				 ...
				 <div class="col-xs-12 col-sm-4 col-md-4" >
					<div class="form-group">
							<label >Miktar:</label>
							<input type="number" pattern="\d*" class="form-control" name="verilenadet" placeholder="250" required />
					</div>
				</div>
				...
				<div class="row">
					<div class="col-xs-12 col-sm-4 col-md-4 none" >
						<div class="form-group">
								...
								<input type="number" pattern="\d*" class="form-control" name="tthesap" value="<?php echo $geneltutar; ?>" required />
						</div>
					</div>
					<div class="col-xs-12 col-sm-6 col-md-6" >
						<div class="form-group">
								<label >Alınan Para (TL):</label>
								<input type="number" pattern="\d" class="form-control" name="apara" placeholder="<?php if($teslim!=""){echo $teslim;}else{echo 250.50;} ?>" required />
						</div>
					</div>
